    ...
    <Card className="w-full h-[calc(100vh-2rem)] overflow-y-auto">
      ...
      <CardBody className="font-normal px-[64px]">
        ...
        <section className="mb-16">
          ...
          <CustomTypography variant="paragraph">
            Before starting the expungement process, you must first ensure that
            you are eligible. Eligibility is based on several factors, including
            the type of offense and how much time has passed since you completed
            your sentence. Generally, indictable offenses (felonies) require a
            10-year waiting period, while disorderly persons offenses
            (misdemeanors) may be eligible after 5 years. Certain serious
            crimes, such as murder, sexual assault, and kidnapping, are not
        ...
        <section className="mb-16">
          ...
          <CustomTypography variant="paragraph">
            You will need to collect several documents to support your Petition
            for Expungement. These documents include:
          </CustomTypography>
          <PointsList
            listPoints={[
              {
