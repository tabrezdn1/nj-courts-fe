  ...
  const essentialForms = [
    {
      ...
      description: "Begin the process of clearing your criminal record. Our step-by-step instructions guide you through each form required for expungement, including the Petition for Expungement (Form A) and related documents.",
    ...
    },
    {
      ...
      description: "Manage civil matters efficiently. Whether you need forms for small claims, landlord-tenant disputes, or other civil actions, we provide all the necessary documents and guidance.",
    ...
    },
    {
      ...
      description: "Navigate family-related legal issues, including divorce, child custody, child support, and adoption. Access commonly requested forms and ensure you meet the court's requirements.",
    ...
    },
    {
      ...
      description: "If you’re involved in a criminal case, our portal provides forms for motions, appeals, and other necessary documentation.",
    ...
    <Card className="w-full h-[calc(100vh-2rem)] overflow-y-auto">
      ...
      <CardBody className="font-normal px-[64px]">
        ...
        <section className="mb-16">
          ...
          <PointsList
            listPoints={[
              { title: "Find the Form You Need", description: "Start by browsing our categories or using the search function to locate the appropriate form for your legal issue." },
              { title: "Fill Out the Form", description: "Each form comes with instructions to guide you through the process. Our system provides helpful tips to ensure accuracy and minimize mistakes." },
              { title: "Save, Submit, or Print", description: "When you’re ready, submit your form electronically (where supported) or print it out for submission to the court. Some forms may require additional documentation, which will be outlined in the instructions." },
              { title: "Track Your Submission", description: "Stay updated on the status of your form through your account dashboard. Notifications will keep you informed if additional steps are required or when your form has been successfully processed." }
            ]}
          />
        </section>
        ...
        <section className="mb-16">
          ...
          <CustomTypography variant="paragraph">
            No matter the legal issue, the New Jersey Courts Online Forms Portal is here to assist you. Explore the platform, find the forms you need, and submit your documents securely and efficiently. Our platform is designed to save you time, provide clarity, and ensure your legal filings are done right the first time.
          </CustomTypography>
